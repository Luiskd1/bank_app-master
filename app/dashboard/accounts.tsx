...
import { Bankschemadata } from './cards'
            ...
            <CardHeader>
                ...
                <CardDescription  className='flex justify-between  '>
                    <Select defaultValue='acc1'>
                        <SelectTrigger className="font-bold text-white w-auto rounded-full">
                    ...
                    <Badge variant={isActive ? 'default' : 'secondary'} className='m-3' onClick={handleToggle}>
